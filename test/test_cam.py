...
from cams.ram3d import GradRAM3d

random.seed(0)
torch.random.manual_seed(0)
x = random.random((120, 10, 10, 10)) / 2 + 0.00001


key = np.array([[0.5, 0.5, 0.5], [0.5, 1, 0.5], [0.5, 0.5, 0.5]])
...
class Moudle1(Module):
    def __init__(self, *args):  # 鍒濆鍖?
        ...
        AvgPool3d_x, AvgPool3d_y, AvgPool3d_z = 5, 5, 5
